// EFEITO DE DIGITAÇÃO DO MEU TITULO PRINCIPAL

const texto = "Desenvolvedor Fullstack";
const span = "<span>Fullstack</span>";

let i = 0;
const elemento = document.querySelector(".inicio-texto h1");

// Função recursiva para simular digitação
function digitar() {
  if (i < texto.length) {
    ...
    setTimeout(() => {
      elemento.innerHTML = texto.replace("Fullstack", span);
    }, 500);
  }
}
